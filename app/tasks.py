...
TASK_MEDIUM = TaskConfig(
    ...
    seed=123,
    max_days=45,
    enabled_services=[ServiceType.INCOME_CERTIFICATE, ServiceType.LAND_REGISTRATION],
    arrival_rate_per_day={
        ServiceType.INCOME_CERTIFICATE: 10.0,
        ServiceType.LAND_REGISTRATION:  5.0,
    },
    digital_intake_ratio=0.72,
    initial_officer_pool=OfficerPool(
        total_officers=10, available_officers=10,
        allocated={
            ServiceType.INCOME_CERTIFICATE: 6,
...
TASK_HARD = TaskConfig(
    ...
    enabled_services=[ServiceType.INCOME_CERTIFICATE, ServiceType.LAND_REGISTRATION],
    arrival_rate_per_day={
        ServiceType.INCOME_CERTIFICATE: 14.0,
        ServiceType.LAND_REGISTRATION:  7.0,
    },
    digital_intake_ratio=0.80,
    initial_officer_pool=OfficerPool(
        total_officers=12, available_officers=12,
        allocated={
            ServiceType.INCOME_CERTIFICATE: 7,
            ServiceType.LAND_REGISTRATION:  5,
        },
    ),
    missing_docs_probability_override=None,
    field_verification_probability_override=None,
